...
@section('content')
    ...
    <div class="row">
        ...
        @if ($user->role!='teacher')
            @if ($completed)
                @if ($completed->mark >= 70)
                    <div class="alert alert-success" role="alert">
                        Вы успешно прошли итоговый тест! В ближайшее время мы свяжемся с вами по поводу получения сертификата. Если у вас есть вопросы, свяжитесь с нами по
                ...
                @else
                    <div class="alert alert-warning" role="alert">
                        Вы прошли итоговый тест, но, к сожалению, не набрали достаточное количество баллов для получения сертификата. Если у вас есть вопросы, свяжитесь с нами по
                        адресу {{ config('app.info_email') }}.
                        <br><br>
                        <a href="{{url('insider/courses/'.$course->id.'/questions/report')}}">Просмотр результатов.</a>
            ...
            @else
                <div class="alert alert-info" role="alert">
                    Для получения сертификата по курсу вам необходимо изучить материалы ниже и набрать не менее 70% правильных ответов в итоговом тесте. Итоговый тест можно пройти только один раз.
        ...
        @if ($user->role != 'teacher' and !$completed)
            <p style="text-align: center"><a class="btn btn-success btn-lg" href="{{url('/insider/courses/'.$course->id.'/questions')}}">Пройти итоговый тест и получить сертификат</a></p>
        @endif
    </div>
    @if ($user->role=='teacher')
        <div class="col-md-4">

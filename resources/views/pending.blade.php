...
@section('content')
    <div class="row" style="margin-top: 15px;">
        <div class="col">
            ...
            <p>Ориентировочное время начала курса - <b>15 марта 2020</b>.

            <p>Когда все будет готово, мы пришлем вам письмо на почту <strong>{{ \Auth::User()->email }}</strong>. Если у вас есть вопросы, вы можете связаться с нами по адресу roctbb@gmail.com</p>
        </div>

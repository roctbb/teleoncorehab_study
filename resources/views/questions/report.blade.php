        ...
        <div class="col">
            ...
            @if ($completed->mark >= 70)
                <div class="alert alert-success" role="alert">
                   Поздравляем, Вы успешно прошли тест! В ближайшее время мы свяжемся с вами по поводу получения сертификата. Если у вас есть вопросы, свяжитесь с нами по адресу {{ config('app.info_email') }}.
                </div>
            @else
                <div class="alert alert-warning" role="alert">
                    К сожалению, Вы не набрали достаточное количество баллов для получения сертификата. Если у вас есть вопросы, свяжитесь с нами по адресу {{ config('app.info_email') }}.
                </div>
            @endif
